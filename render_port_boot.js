// Bind $PORT immediately so Render detects the web service even while
// Telegram/MongoDB startup work is still initializing.
...
const renderServer = http.createServer(earlyHandler);
...
express.application.listen = function (...args) {
  ...
  // listener instead of binding the same port a second time.
